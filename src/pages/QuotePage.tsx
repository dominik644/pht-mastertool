        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2 max-h-[480px] overflow-y-auto">
              {q.filteredProducts.slice(0, 80).map((p) => (
              ...
              {q.filteredProducts.length > 80 && (
                <p className="text-xs text-slate-500 text-center py-2">
                  {q.filteredProducts.length - 80} weitere Treffer – Suche eingrenzen
                </p>
              )}
            </CardContent>
          </Card>
...
export function QuotePage() {
  ...
  if (isMobileView) return <QuoteMobile />;
  return <QuotePageDesktop />;
}
