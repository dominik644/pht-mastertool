    ...
    <div className="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <Card className="mb-8">
        ...
        <CardContent className="text-sm text-slate-400 space-y-2">
          ...
          <p className="pt-2 text-xs text-slate-600">Faktoren: Keyword-Match, Budget, Region, Branche, Produktprofil-Fit</p>
        </CardContent>
      </Card>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge variant="score">{stats.profileDistribution[p.name] ?? matches.length}</Badge>
                    </div>
                    ...
                    <p className="text-xs text-pht-400 mt-2">Produkte: {p.products.join(', ')}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
