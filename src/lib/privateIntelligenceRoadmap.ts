...
export const PRIVATE_INTELLIGENCE_ROADMAP: PrivateIntelligenceRoadmapItem[] = [
  ...
  { id: 'planning-apps-intl', label: 'Planning Applications UK (Glenigan) / US (ConstructConnect)', status: 'planned', effort: 'M', cost: '€€€ Abo', tier: 'tool', note: 'Abo erforderlich – Glenigan/ConstructConnect ohne öffentliche API' },
