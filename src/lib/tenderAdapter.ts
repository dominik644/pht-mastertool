...
export function globalToTender(raw: GlobalTenderRaw, scoring: ScoreResult, allForSimilarity?: Tender[]): Tender {
  ...
  const tender: Tender = {
    ...
    scoreBreakdown: scoring.breakdown,
      ...
      revenueTier: raw.revenueTier,
      revenuePotentialLevel: raw.revenuePotentialLevel,
      portfolioMatchProb: raw.portfolioMatchProb,
      winProbability: raw.winProbability,
      urgencyScore: raw.urgencyScore,
      overallOpportunityScore: raw.overallOpportunityScore,
      probabilityBreakdown: raw.probabilityBreakdown,
    productMatch,
