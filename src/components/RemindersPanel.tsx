...
export function RemindersPanel() {
  ...
  if (reminders.length === 0) {
    return (
      <Card>
        ...
        <CardContent><p className="text-sm text-slate-600">Keine anstehenden Deadlines.</p></CardContent>
      </Card>
    );
  }
  ...
  return (
    <Card>
      <CardHeader><h2 className="text-sm font-semibold text-white flex items-center gap-2"><AlertTriangle className="w-4 h-4 text-amber-400" /> Erinnerungen ({reminders.length})</h2></CardHeader>
