...
const CASES = [
  ...
  {
    label: 'Abwassertechnik im Freien',
    title: 'Abwassertechnik im Freien – Kläranlage Erweiterung',
    description: 'Planung und Bau Abwasserbehandlung Außenanlage',
    cpvCodes: ['45252100'],
    expectMatch: false,
    expectMaxScore: 0,
  },
  {
    label: 'Kläranlage Wartungsvertrag',
    title: 'Wartungsvertrag Kläranlage Abwasserbehandlung',
    cpvCodes: ['90700000'],
    expectMatch: false,
    expectMaxScore: 0,
  },
  {
    ...
    title: 'Design and construction of wastewater treatment plant',
    description: 'Sewage treatment effluent treatment outdoor installation',
    cpvCodes: ['45252100'],
    expectMatch: false,
    expectMaxScore: 0,
  },
  {
    label: 'Facility Management Beratung',
    title: 'Facility Management und Beratungsleistungen Verwaltungsgebäude',
    cpvCodes: ['79993000'],
    expectMatch: false,
    expectMaxScore: 0,
  },
  {
    label: 'Reinigungsdienst ohne Geräte',
    title: 'Reinigungsdienst und Unterhaltsreinigung Schulgebäude',
    cpvCodes: ['90910000'],
    expectMatch: false,
    expectMaxScore: 0,
  },
  {
    label: 'Waschanlage Kisten (PHT Kern)',
    title: 'Lieferung Industriewaschanlage Kistenwaschanlage Behälterwaschanlage',
    description: 'Sonderbau Waschanlage für Lebensmittelbetrieb',
    cpvCodes: ['42924700'],
    expectMatch: true,
    expectMinScore: 70,
  },
  {
    label: 'Schlachthof Bau mit Waschanlage',
    title: 'Neubau Schlachthof inkl. Lieferung Kistenwaschanlage und Hygienestationen',
    description: 'Bauarbeiten Schlachthof mit Industriewaschanlage Sonderbau',
    cpvCodes: ['45210000', '42924700'],
    industry: 'Food',
    expectMatch: true,
    expectMinScore: 40,
  },
  {
    label: 'Schlachthof reine Bauarbeiten',
    title: 'Bauarbeiten Neubau Schlachthof Generalunternehmer Rohbau',
    description: 'Hochbau und Tiefbau für Fleischverarbeitungsbetrieb',
    cpvCodes: ['45210000'],
    industry: 'Food',
    expectMatch: false,
    expectMaxScore: 0,
  ...
  {
    label: 'Hygieneplanung HACCP',
    title: 'Hygieneplanung und HACCP-Beratung für Lebensmittelbetrieb',
    description: 'Erstellung Hygienekonzept und GMP-Beratung',
    cpvCodes: ['79417000'],
    industry: 'Food',
    expectMatch: false,
    expectMaxScore: 0,
  ...
  {
    label: 'Hygienestation trotz Hygienekonzept',
    title: 'Lieferung Hygienestationen und Schaumstationen inkl. Hygienekonzept-Integration',
    description: 'Beschaffung Niederdruckanlage Produktionseingang',
    cpvCodes: ['42996600'],
    industry: 'Food',
    expectMatch: true,
    expectMinScore: 40,
  ...
  {
    label: 'Tiefbau ohne Geräte',
    title: 'Tiefbau und Erdarbeiten Straßenbau Kommune',
    cpvCodes: ['45233100'],
    expectMatch: false,
    expectMaxScore: 0,
  },
