        ...
        configureServer(server) {
          ...
          const mountVercelApi = (path: string, modulePath: string, opts?: { passOptions?: boolean; route?: string }) => {
            server.middlewares.use(path, async (req, res) => {
              ...
              process.env.PLAUD_REFRESH_TOKEN = env.PLAUD_REFRESH_TOKEN || process.env.PLAUD_REFRESH_TOKEN;
          ...
          mountVercelApi('/api/bc-purchase-activity', './api/bc.js', { passOptions: true, route: 'purchase-activity' });
          ...
          mountVercelApi('/api/plaud', './api/snapaddy.js', { passOptions: true, route: 'plaud' });
          ...
          mountVercelApi('/api/schedule-calendar-feed', './api/schedule.js', { passOptions: true, route: 'calendar-feed' });
