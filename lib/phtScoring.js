...
import { isServiceOnlyCleaning, textHasExclusion, textHasNonPHTServiceExclusion, hasEquipmentSignal, qualifiesForGoScore } from './phtMatchRules.js';
...
export function scoreTender(tender) {
  ...
  if (!qualifiesForGoScore(text, tender.cpvCodes ?? [], priceListArticle, cpvMatchesEquipment)) {
