...
import { matchesPHTText, extractOcdsReleases, mapOcdsRelease } from './ocdsMapper.js';

const API_PROXY = '/api/za-etenders';
...
function buildUrl() {
  ...
  const qs = `dateFrom=${fmt(from)}&dateTo=${fmt(to)}&pageNumber=1&pageSize=60`;
