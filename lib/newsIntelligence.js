...
import { runUkPlanningLeads } from './ukPlanningLeads.js';
import { scanSubGuTendersFromBulk } from './subGuTenderScan.js';
...
export const PHT_FOOD_EXPANSION_KEYWORDS = [
  ...
  // Früh-Signale Bauvorhaben (Genehmigung, Netz, Jobs)
  'immissionsschutz', 'bimschg', 'genehmigungsverfahren', 'umweltverträglichkeit',
  'netzanschluss', 'großanschluss', 'stromanschluss', 'gasanschluss',
  'plant manager', 'werksleiter', 'production manager', 'site manager',
  'förderbescheid', 'förderzusage', 'kfw förderung', 'efre projekt',
  'capex', 'capital expenditure', 'investitionsprogramm',
  'bürgerinitiative', 'einspruch', 'widerspruch', 'anhörung', 'öffentliche auslegung',
  'nrw.invest', 'wirtschaftsförderung', 'standortportal',
];

/** Bürgerinitiativen / Einspruch – starkes Signal dass ein Projekt existiert. */
export const CITIZEN_OPPOSITION_KEYWORDS = [
  'bürgerinitiative', 'buergerinitiative', 'citizens initiative', 'citizen initiative',
  'citizen opposition', 'protest against', 'protest gegen', 'einspruch gegen',
  'petition gegen', 'widerstand gegen', 'lokalprotest', 'initiative gegen',
  'residents oppose', 'objection to', 'objectors', 'opposition to factory',
  'opposition to plant', 'gegen das werk', 'gegen den schlachthof', 'gegen die fabrik',
  'gegen das logistikzentrum', 'not in my backyard', 'nimby',
  'association de défense', 'opposition citoyenne', 'pétition contre',
];
...
/** DAX/MDAX + FMCG/Logistik – Frühindikator bei Namensnennung (private Bauchancen). */
export const DAX_MDAX_FOOD_LOGISTICS_COMPANIES = [
  // Global FMCG
  'Nestlé', 'Nestle', 'Unilever', 'Danone', 'Henkel', 'Beiersdorf',
  'Mondelez', 'Kraft Heinz', 'General Mills', 'Kellogg', 'Kellanova',
  'Mars', 'Ferrero', 'Lindt', 'Barry Callebaut', 'Tate & Lyle',
  'Associated British Foods', 'ABF', 'Premier Foods', 'Nomad Foods',
  'Symrise', 'Givaudan', 'Kerry Group', 'McCormick',
  // Dairy
  'FrieslandCampina', 'Arla', 'Lactalis', 'Müller', 'Mueller Milch',
  'Emmi', 'Hochland', 'Bergader', 'DMK', 'Saputo', 'Bel Group', 'Savencia',
  'Ornua', 'Yili', 'Fonterra',
  // Meat & protein
  'Tönnies', 'Toennies', 'Westfleisch', 'Rügenwalder', 'Rugenwalder',
  'Vion', 'JBS', 'Tyson Foods', 'Cargill', 'Bunge', 'ADM', 'Smithfield',
  'Danish Crown', 'Hormel',
  // DE/AT/CH brands
  'Dr. Oetker', 'Dr Oetker', 'Bahlsen', 'Haribo', 'Coppenrath',
  'FRoSTA', 'Iglo', 'Hengstenberg', 'Harry-Brot', 'Aryzta',
  // Logistics
  'Deutsche Post', 'DHL', 'Kühne+Nagel', 'Kuehne Nagel', 'Rhenus', 'Dachser',
  'Schenker', 'DB Schenker', 'Hellmann', 'Fiege', 'Raben Group', 'GLS',
  'Hermes', 'Amazon Logistics', 'XPO', 'CEVA',
  // Plant engineering (frühe Bau-Signale)
  'GEA', 'Krones', 'Multivac', 'Siemens', 'Siemens Logistics',
];
...
export const NEWS_GOOGLE_QUERIES = [
  ...
  // Private Bauchancen – LinkedIn/PR-Signale (via Google News)
  { q: 'Nestlé neues Werk Investition', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Arla neue Produktionsstätte', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'EU' },
  { q: 'Mondelez factory expansion Europe', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'Ferrero new plant investment', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'Unilever manufacturing site expansion', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'global' },
  { q: 'site:linkedin.com food plant expansion', hl: 'en', gl: 'US', segment: 'private-construction', region: 'global' },
  { q: 'site:linkedin.com Lebensmittelwerk Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'site:linkedin.com dairy factory construction', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'groundbreaking ceremony food processing plant', hl: 'en', gl: 'US', segment: 'private-construction', region: 'global' },
  { q: 'Baustart Produktionshalle Lebensmittel', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  // Baugenehmigungen & Bauvorhaben (öffentliche Register → News-Aggregation)
  { q: 'Baugenehmigung Lebensmittelbetrieb', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Baugenehmigung Gewerbebau Logistikzentrum', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Bauvorhaben Lebensmittelwerk', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Gewerbebau Neubau Investition Millionen', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Industriepark Lebensmittel Investition', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  // Regionale Wirtschaftsförderung
  { q: 'Invest in Bavaria Lebensmittel', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'NRW.INVEST Gewerbe Investition Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Wirtschaftsförderung Lebensmittelbetrieb Standort', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Wirtschaftsförderung Logistikzentrum Investition', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Gewerbeimmobilie Lebensmittelproduktion', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Greenfield food plant Germany', hl: 'en', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'new cold storage warehouse Europe', hl: 'en', gl: 'GB', segment: 'logistics', region: 'EU' },
  { q: 'Generalunternehmer Lebensmittelbetrieb Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  // Standortportale Bayern / NRW / IHK-Flächen (Google News – kein offizielles RSS)
  { q: 'Standortportal Bayern Industriefläche Gewerbe', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'IHK Gewerbefläche Bayern Lebensmittel', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Invest in Bavaria neues Werk Standort', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'NRW.INVEST Industriefläche Gewerbe', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Standortportal NRW Gewerbeimmobilie', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  // Bürgerinitiativen / Einsprüche = Projekt existiert (Google News)
  { q: 'Bürgerinitiative Lebensmittelbetrieb Neubau Einspruch', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Bürgerinitiative Logistikzentrum Bauvorhaben', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Einspruch Gewerbebau Fabrik Genehmigung', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'öffentliche Auslegung Industrieanlage Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  // Immissionsschutz / TA Luft / Wasserrecht
  { q: 'Immissionsschutz Genehmigung Lebensmittelbetrieb Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'BImSchG TA Luft Genehmigung Fabrik Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Wasserrecht Genehmigung Industrieanlage Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'environmental permit food processing plant construction', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  // Stellenanzeigen – Plant Manager / Greenfield (Indeed/StepStone via Google News)
  { q: 'site:indeed.com plant manager food factory greenfield', hl: 'en', gl: 'US', segment: 'private-construction', region: 'global' },
  { q: 'site:stepstone.de Werksleiter Lebensmittel Greenfield', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'site:indeed.com production manager new food plant', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'site:stepstone.de Plant Manager Neubau Produktion', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  // Reverse Intelligence – Anlagenbauer-Aufträge (Multivac/Krones/GEA)
  { q: 'Multivac Auftrag neues Werk Lebensmittel', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Krones Brauerei Neubau Auftrag', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'GEA food processing plant order contract', hl: 'en', gl: 'DE', segment: 'private-construction', region: 'EU' },
  { q: 'Multivac packaging line new factory', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  // Netzanschluss-Signale
  { q: 'Netzanschluss Großanschluss Strom Industrie Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Gasanschluss Gewerbe Großverbraucher Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'grid connection industrial plant megawatt', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  // BEI / KfW / EFRE Förderentscheidungen
  { q: 'KfW Förderung Industrieinvestition Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'EFRE Förderbescheid Gewerbe Investition', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'European Investment Bank food processing loan', hl: 'en', gl: 'EU', segment: 'private-construction', region: 'EU' },
  { q: 'BEI Darlehen Lebensmittelindustrie Werk', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'EU' },
  // CapEx-Signale (öffentliche Presse/News – kein SEC-API)
  { q: 'Jahresbericht Investitionen Neubau Werk Millionen', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'earnings call capex expansion new plant', hl: 'en', gl: 'US', segment: 'private-construction', region: 'global' },
  { q: 'bond prospectus food manufacturing facility', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  // Bürgerinitiativen – Schlachthof / Food Plant / Logistik (DE/EN/FR)
  { q: 'Bürgerinitiative Schlachthof Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Bürgerinitiative Lebensmittelbetrieb Fabrik Einspruch', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Bürgerinitiative gegen Logistikzentrum Neubau', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'Einspruch Schlachthof Genehmigung', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DE' },
  { q: 'Widerstand neues Lebensmittelwerk Anwohner', hl: 'de', gl: 'DE', segment: 'private-construction', region: 'DACH' },
  { q: 'citizen opposition food processing plant', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'protest new food factory planning permission', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'UK' },
  { q: 'residents oppose slaughterhouse abattoir', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'opposition new dairy factory cold store', hl: 'en', gl: 'GB', segment: 'private-construction', region: 'EU' },
  { q: 'association défense usine agroalimentaire', hl: 'fr', gl: 'FR', segment: 'private-construction', region: 'FR' },
  { q: 'pétition contre abattoir nouvelle usine', hl: 'fr', gl: 'FR', segment: 'private-construction', region: 'FR' },
  { q: 'opposition citoyenne usine alimentaire', hl: 'fr', gl: 'FR', segment: 'private-construction', region: 'FR' },
  // Sub-GU Ausschreibungen – HLS/TGA/Hygiene
  { q: 'Nachunternehmer HLS TGA Hygiene Ausschreibung', hl: 'de', gl: 'DE', segment: 'foam-low-pressure-hygiene', region: 'DACH' },
  { q: 'Nachunternehmer Lebensmittelbetrieb Neubau Vergabe', hl: 'de', gl: 'DE', segment: 'foam-low-pressure-hygiene', region: 'DACH' },
  { q: 'Personenschleuse Ausschreibung Vergabe', hl: 'de', gl: 'DE', segment: 'foam-low-pressure-hygiene', region: 'DACH' },
  { q: 'Schaumdesinfektion Vergabe Ausschreibung', hl: 'de', gl: 'DE', segment: 'foam-low-pressure-hygiene', region: 'DE' },
  { q: 'Hygienestation Niederdruckanlage Ausschreibung', hl: 'de', gl: 'DE', segment: 'foam-low-pressure-hygiene', region: 'DACH' },
  { q: 'subcontractor sanitary food plant tender', hl: 'en', gl: 'GB', segment: 'foam-low-pressure-hygiene', region: 'EU' },
  { q: 'subcontractor hygiene equipment food factory', hl: 'en', gl: 'GB', segment: 'foam-low-pressure-hygiene', region: 'EU' },
  { q: 'personnel hygiene lock tender food processing', hl: 'en', gl: 'GB', segment: 'foam-low-pressure-hygiene', region: 'EU' },
  { q: 'foam disinfection station tender', hl: 'en', gl: 'GB', segment: 'foam-low-pressure-hygiene', region: 'EU' },
  { q: 'sous-traitant hygiène usine alimentaire marché', hl: 'fr', gl: 'FR', segment: 'foam-low-pressure-hygiene', region: 'FR' },
  { q: 'lot TGA hygiène industrie alimentaire appel offres', hl: 'fr', gl: 'FR', segment: 'foam-low-pressure-hygiene', region: 'FR' },
];
...
export const NEWS_INTELLIGENCE_SOURCES = [
  ...
  // Private Bauchancen – Konzernpresse & Regional-Feeds (kein Paywall-Scraping)
  { id: 'mondelez-news', name: 'Mondelez IR News', type: 'rss', url: 'https://ir.mondelezinternational.com/rss/news-releases.xml', segment: 'private-construction', region: 'global' },
  { id: 'barry-callebaut-news', name: 'Barry Callebaut News', type: 'rss', url: 'https://www.barry-callebaut.com/en/media/news/rss', segment: 'private-construction', region: 'EU' },
  { id: 'emmi-news', name: 'Emmi Presse', type: 'rss', url: 'https://www.emmi.com/de-CH/medien/medienmitteilungen/rss', segment: 'private-construction', region: 'DACH' },
  { id: 'hochland-news', name: 'Hochland News', type: 'rss', url: 'https://www.hochland-group.com/de/presse/news/rss', segment: 'private-construction', region: 'DACH' },
  // Bauvorhaben-Placeholder: Invest in Bavaria hat kein RSS – Google News Query oben als Proxy
  { id: 'gn-invest-bavaria', name: 'Google News: Invest in Bavaria', type: 'google-news', url: buildGoogleNewsUrl({ q: 'Invest in Bavaria neues Werk', hl: 'de', gl: 'DE' }), segment: 'private-construction', region: 'DE', query: 'Invest in Bavaria neues Werk' },
  { id: 'gn-baugenehmigung-lm', name: 'Google News: Baugenehmigung LM', type: 'google-news', url: buildGoogleNewsUrl({ q: 'Baugenehmigung Lebensmittelbetrieb Neubau', hl: 'de', gl: 'DE' }), segment: 'private-construction', region: 'DE', query: 'Baugenehmigung Lebensmittelbetrieb Neubau' },
  // Öffentliche Förder-Presse (kostenlos)
  { id: 'kfw-presse', name: 'KfW Pressemitteilungen', type: 'rss', url: 'https://www.kfw.de/About-KfW/Newsroom/Press-News/RSS/', segment: 'private-construction', region: 'DE' },
  { id: 'eib-press', name: 'European Investment Bank Press', type: 'rss', url: 'https://www.eib.org/en/press/all/index-rss.htm', segment: 'private-construction', region: 'EU' },
];
...
export function scoreNewsArticle(title, description = '') {
  ...
  const matchedOpposition = matchKeywords(lower, CITIZEN_OPPOSITION_KEYWORDS);
  ...
  const hasOppositionWithProject =
    matchedOpposition.length > 0 && (hasIndustrySignal || hasExpansionSignal || matchedOpposition.length >= 2);
  if (hasOppositionWithProject) score += Math.min(18 + matchedOpposition.length * 4, 28);

  if (!hasExpansionSignal && !hasOppositionWithProject) score = Math.max(0, score - 25);
  if (!hasIndustrySignal && !matchedCompanies.length && !hasOppositionWithProject) {
  ...
  const projectType = hasOppositionWithProject && !hasExpansionSignal
    ? 'Bürgerinitiative (Projekt-Signal)'
    : guessProjectType(matchedExpansion, matchedMega, industryHits);

  const base = {
    relevanceScore: score,
    isMegaExpansion,
    isCitizenOpposition: hasOppositionWithProject,
    matchedKeywords: [...new Set([...matchedExpansion, ...matchedMega, ...matchedScale, ...matchedOpposition])].slice(0, 12),
...
export async function runNewsIntelligence(options = {}) {
  ...
  if (options.includeUkPlanning !== false) {
    try {
      const uk = await runUkPlanningLeads({ maxPages: options.ukPlanningMaxPages ?? 40 });
      allRaw.push(...uk.leads);
    } catch {
      // UK Planning API optional – do not fail entire run
    }
  }

  if (options.includeSubGuScan !== false) {
    const subGu = scanSubGuTendersFromBulk();
    allRaw.push(...subGu.leads);
  }
  ...
  const output = {
    ...
    ukPlanningCount: freshRelevant.filter((l) => l.sourceType === 'planning-api').length,
    subGuCount: freshRelevant.filter((l) => l.leadType === 'sub-gu-tender').length,
    oppositionCount: freshRelevant.filter((l) => l.isCitizenOpposition).length,
    signalType: 'early-indicator',
