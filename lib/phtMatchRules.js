...
export const PHT_FOOD_FACILITY_KEYWORDS = [
  ...
  'dairy plant', 'dairy facility', 'dairy factory', 'cheese plant', 'cheese factory', 'käserei', 'kaeserei', 'fromagerie', 'laiterie',
  ...
  'brewery', 'brauerei', 'beverage plant',
  'getränkebetrieb', 'getraenkebetrieb', 'saftverarbeitung', 'saftwerk', 'juice processing plant',
  'juice plant', 'fruit juice processing', 'confectionery plant',
  ...
  'alt protein facility', 'alt-protein facility',
  'agroalimentaire', 'industrie alimentaire', 'usine alimentaire', 'usine de viande', 'usine de jus',
  'boulangerie industrielle', 'transformation alimentaire',
