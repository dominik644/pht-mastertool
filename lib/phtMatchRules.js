...
export const PHT_FOOD_FACILITY_KEYWORDS = [
  ...
  'food industry', 'food manufacturing', 'food production facility',
  ...
  'molkerei', 'dairy plant', 'dairy facility', 'schlachthof', 'slaughterhouse', 'abattoir',
...
const PHT_FOOD_CONTEXT_TERMS = [
  'lebensmittel', 'food', 'nahrungsmittel', 'molkerei', 'schlachthof', 'bäckerei', 'baeckerei',
  'metzgerei', 'fleisch', 'dairy', 'meat processing', 'brewery', 'brauerei', 'beverage',
