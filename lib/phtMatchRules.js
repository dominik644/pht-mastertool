...
export const PHT_FOOD_FACILITY_KEYWORDS = [
  ...
  'agroalimentaire', 'industrie alimentaire', 'usine alimentaire', 'usine de viande', 'transformation alimentaire',
...
const PHT_FOOD_CONTEXT_TERMS = [
  ...
  'bäckerei', 'baeckerei', 'metzgerei', 'fleisch', 'fleischverarbeitungsbetrieb', 'dairy', 'meat processing', 'brewery', 'brauerei',
