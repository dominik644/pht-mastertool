...
- Du kennst die PHT Preisliste 2026 (context.priceList): ${context.priceList?.productCount || '?'} Artikel, Preisspanne ca. ${context.priceList?.priceMin || '?'}–${context.priceList?.priceMax || '?'} € netto. Für Kostenvoranschläge /quote nutzen oder Tender-Drawer „Kostenvoranschlag“
