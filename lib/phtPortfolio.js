  ...
  },
  {
    ...
    keywords: {
      de: [
        ...
        'fleischverarbeitung', 'fleischverarbeitungsbetrieb',
        'saftverarbeitung', 'saftwerk',
        'vegan produktionsanlage', 'pflanzliche alternative', 'pflanzliches fleisch',
      ...
      en: [
        ...
        'bakery plant', 'bakery factory', 'industrial bakery',
        'juice processing plant', 'fruit juice processing',
        'vegan production plant', 'plant-based protein facility', 'alternative protein facility', 'alt protein facility',
        'fruit processing plant', 'vegetable processing plant', 'packing house', 'packhouse', 'sorting plant',
        'produce plant', 'fresh produce plant',
      ...
      fr: [
        ...
        'usine fruits', 'transformation légumes', 'fruits et légumes',
    ...
    minBudgetEur: 50000,
    exclusionKeywords: ['catering only', 'meal delivery', 'food supply contract', 'backwaren lieferung', 'bread delivery', 'saft lieferung', 'juice supply', 'vegan catering'],
