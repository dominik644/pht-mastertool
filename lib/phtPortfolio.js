  ...
  },
  {
    ...
    keywords: {
      de: [
        ...
        'nahrungsmittelbetrieb', 'molkerei', 'schlachthof', 'bäckerei', 'baeckerei', 'brauerei',
        'fleischverarbeitung', 'produktionshalle', 'anlagenbau', 'umbau', 'zubau', 'neubau', 'erweiterung',
        'sanierung', 'modernisierung',
      ],
      en: [
        'food facility', 'food plant', 'food processing', 'food industry', 'dairy plant', 'slaughterhouse',
        'brewery', 'meat processing', 'food manufacturing', 'new build', 'renovation', 'extension',
        'turnkey food', 'food processing plant construction',
      ],
      fr: [
