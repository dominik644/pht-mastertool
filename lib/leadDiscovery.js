...
export const LEAD_DISCOVERY_SOURCES = [
  ...
  { id: 'gn-subgu-hls', name: 'Google News: Sub-GU HLS TGA', type: 'google-news', url: 'https://news.google.com/rss/search?q=Nachunternehmer+HLS+TGA+Hygiene&hl=de&gl=DE&ceid=DE:de', segment: 'foam-low-pressure-hygiene', region: 'DACH' },
  { id: 'gn-buergerinitiative-schlachthof', name: 'Google News: Bürgerinitiative Schlachthof', type: 'google-news', url: 'https://news.google.com/rss/search?q=B%C3%BCrgerinitiative+Schlachthof&hl=de&gl=DE&ceid=DE:de', segment: 'private-construction', region: 'DE' },
  // NL
