...
export const PRODUCT_PROFILES = [
  ...
  },
  {
    ...
    icon: '🏗️',
    description: 'Umbau, Zubau, Neubau von Lebensmittelbetrieben – Hygieneanlagen, Waschtechnik, Spinde, Reinigungsausstattung',
    useCases: ['Lebensmittelbetrieb-Neubau', 'Produktionshalle-Umbau', 'Wareneingang Food', 'Personalhygiene Anlage'],
    keywords: [
      'lebensmittelbetrieb', 'lebensmittelbetriebe', 'lebensmittel betrieb', 'food processing', 'food facility',
      'food plant', 'umbau', 'zubau', 'neubau', 'erweiterung', 'anlagenbau', 'produktionshalle',
      'nahrungsmittel', 'molkerei', 'schlachthof', 'fleischverarbeitung',
    ],
    products: [
      'Kistenwaschanlage EKW', 'Hygienestation COMBI', 'Schaumstation Niederdruck',
      'Spindsysteme Umkleide', 'Behälterreinigungsanlage', 'Betriebshygiene-Komplettausstattung',
    ],
  },
  {
