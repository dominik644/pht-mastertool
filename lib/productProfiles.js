...
export const PRODUCT_PROFILES = [
  {
    ...
    keywords: ['hand', 'hygiene', 'desinfektion', 'spender', 'wasch', 'personal', 'ewg', 'hygienestation', 'handreinigungsbecken', 'seifenspender', 'händetrockner', 'eingangskontrolle'],
    products: ['EWG Handhygiene-System', 'Hygiene-Spender', 'COMBI Hygienestation', 'Handreinigungsbecken EWG', 'Eingangskontrolle HDT/HST'],
  },
  {
    ...
    keywords: ['cleaning', 'reinigung', 'cip', 'washing', 'niederdruck', 'crate', 'container', 'wasch', 'behälterreinigung', 'palettenreinigung', 'frontlader', 'waschkabinett', 'kistenwäsche'],
    products: ['Niederdruck-Reinigungssystem', 'Industriewaschbecken', 'Behälterreinigungsanlage', 'Waschkabinett'],
  },
  {
    id: 'betriebshygiene',
    ...
    keywords: ['industrial', 'facility', 'sohle', 'eingang', 'sanicare', 'production', 'betrieb', 'sohlenreiniger', 'sohlendesinfektion', 'portaldrehkreuz', 'schürzenreinigung', 'stiefel'],
    products: ['SANICARE Eingangssystem', 'DZW Sohlenreiniger', 'EKW Industrieanlage', 'Hygienestation COMBI', 'Sohlen- und Stiefelreiniger'],
  },
  {
    id: 'komplettloesung',
    name: 'Komplettlösung',
  ...
  },
  {
    ...
    icon: '🗄️',
    description: 'Spinde, Garderoben, Wertfachschränke, Umkleiden, Feuerwehrspinde',
    keywords: [
  ...
  },
  {
    ...
    icon: '🧹',
    description: 'Besen, Bürsten, Schaufeln und Reinigungsbedarf',
    keywords: [
      ...
      'cleaning brush', 'broom', 'dustpan',
    ],
    products: ['Besen', 'Bürsten', 'Kehrschaufeln', 'Reinigungsbedarf'],
  },
];
