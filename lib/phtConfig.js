...
/**
 * Marktführer-Strategie (Portfolio, pht.group, Nutzer-Vorgaben).
 * Kein Bau/Generalunternehmer – nur Ausrüstung & Anlagen.
 */
export const PHT_STRATEGY = {
  focus: 'equipment-only',
  coreProducts: ['industrial-washers', 'foam-low-pressure-hygiene', 'lockers-wardrobe', 'personal-hygiene', 'betriebshygiene'],
  channels: ['public-tenders', 'private-intelligence'],
  revenueMonthlyEur: 1_000_000,
  revenueAnnualEur: 12_000_000,
  geoPriority: ['DACH', 'EU', 'worldwide'],
  exclude: ['cleaning-services', 'general-construction', 'hygiene-consulting-only'],
};
