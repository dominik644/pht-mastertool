...
export const TED_SEARCH_QUERIES = [
  ...
  'FT~(food facility construction OR lebensmittelbetrieb neubau)',
...
export const TED_FOOD_FACILITY_QUERIES = [
  'FT~(molkerei OR milchbildungszentrum OR milchverarbeitung OR dairy plant)',
  'FT~(milchwerk OR käserei OR cheese plant OR laiterie)',
  'FT~(agroalimentaire OR industrie alimentaire OR usine alimentaire)',
  'FT~(food processing plant OR food facility OR food manufacturing facility)',
  'FT~(slaughterhouse OR abattoir OR meat processing plant)',
  'FT~(lebensmittelbetrieb OR nahrungsmittelbetrieb)',
  'FT~(brauerei neubau OR brewery construction OR brewery extension)',
  'FT~(cuisine centrale OR kühlhaus OR cold storage)',
  'PC=71300000 AND FT~(milchbildungszentrum OR food plant OR lebensmittelbetrieb OR food processing)',
  'PC=71200000 AND FT~(food processing OR lebensmittelbetrieb OR dairy plant)',
  'PC=45212422 AND FT~(cuisine centrale OR küche OR kitchen OR alimentaire)',
];
