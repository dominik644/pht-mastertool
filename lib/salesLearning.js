 ...
 * @param {{ leadRating?: LeadRating, visitRelevant?: boolean | null, visitOutcome?: VisitOutcome, sectorHit?: string }} patch
 */
 ...
 * @param {string} [sector]
 */
export function adjustPriorityScore(baseScore, customerId, sector) {
  const store = loadSalesFeedback();
