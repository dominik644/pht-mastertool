...
function allocateTEDQueryLimits(totalLimit) {
  const coreQueries = [...TED_SEARCH_QUERIES, ...TED_CPV_QUERIES, ...TED_DE_CPV_QUERIES, ...TED_DACH_QUERIES];
  const countryQueries = TED_COUNTRY_QUERIES.slice(0, TED_COUNTRY_QUERY_CAP);
